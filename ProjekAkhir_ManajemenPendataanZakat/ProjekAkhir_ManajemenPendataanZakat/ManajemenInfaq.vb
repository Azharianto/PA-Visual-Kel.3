...
Public Class ManajemenInfaq
    Private Sub ManajemenInfaq_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call koneksi()
        Call Kosong()
        'Call TampilJenis()
    ...
    Sub TampilManajemen()
        ...
        DataGridView1.DataSource = DS.Tables("infaq")
    ...
    Sub AturGrid()
        ...
        DataGridView1.Columns(0).HeaderText = "IdInfaq"
    ...
    Private Sub btnHapus_Click(sender As Object, e As EventArgs) Handles btnHapus.Click
        If txtID.Text = "" Then
            ...
            txtID.Focus()
        Else
            If MessageBox.Show("Yakin akan menghapus Data tbinfaq" & txtID.Text &
                               " ?", "", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
                CMD = New MySqlCommand("Delete From tbinfaq Where IdInfaq = '" & txtID.Text & "'", CONN)
                CMD.ExecuteNonQuery()
                Call Kosong()
                Call TampilManajemen()
            Else
    ...
    Private Sub txtCari_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtCari.KeyPress, txtNama.KeyPress
        If e.KeyChar = Chr(13) Then
            CMD = New MySqlCommand("Select * From tbinfaq where IdInfaq like '%" & txtID.Text & "%'", CONN)
            RD = CMD.ExecuteReader
            RD.Read()

            If RD.HasRows Then
                RD.Close()
                DA = New MySqlDataAdapter("Select * From tbinfaq where IdInfaq like '%" & txtID.Text & "%'", CONN)
                DS = New DataSet
                DA.Fill(DS, "Dapat")
    ...
    Private Sub btnUbah_Click(sender As Object, e As EventArgs) Handles btnUbah.Click
        If txtID.Text = "" Then
            ...
            txtID.Focus()
        Else
            Dim Ubah As String = "Update tbinfaq set IdInfaq = '" & txtID.Text & "', 
                                                        nama ='" & txtNama.Text & "', 
